...
<html
  ...
  data-assets-path="<?php echo base_url('asset')?>/assets/"
...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo base_url('asset')?>/assets/img/favicon/favicon.ico" />
    ...
    <link rel="stylesheet" href="<?php echo base_url('asset')?>/assets/vendor/libs/apex-charts/apex-charts.css" />
